          ...
          <div className="desarrollo-detalle">
            ...
            >
              <img
                ...
                alt="GitHub"
                width="70"
                height="28" style={{ border: '1px solid #ccc' , borderRadius: '5px' }}       
              />
            </a>
          </div>
        </div>
...
<div className="desarrollo-descA"> 
  ...
  {/* Proyecto 4 */}
        <div className="desarrollo-inventory ejeY">
          <div className="imagen-placeholder">
            <img
              src={isMobile ? "/inventory-mobile.jpeg" : "/inventory.png"}              alt="inventory"
              className="image-proyect"
            />
          </div>
<div className="desarrollo-descA"> 

            <span>   Aplicación de gestion de inventario, con registro, login, autenticación y encriptación de usuarios.</span>
          </div>


          <div className="desarrollo-detalle">
            <a
              href="https://inventory-management-taupe-one.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="desarrollo-link"
            >
            ...
            <a
              href="https://github.com/alexismouwid/inventory-management"
              target="_blank"
              rel="noopener noreferrer"
              className="desarrollo-link github"
            >

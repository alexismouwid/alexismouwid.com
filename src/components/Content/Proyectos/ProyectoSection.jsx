...
const proyectos = [
  ...
  { id: "proyecto-9", imagen: "/coreds.png", alt: "coreds", descripcion: "Tienda online de dispositivos tecnológicos con catálogo, botones de llamado a la acción, especificación de mensaje y producto directo al WhatsApp del vendedor.", deploy: "https://coreds-tecnologies.vercel.app/", github: "https://github.com/alexismouwid/COREDS-Tecnologies", color: "bg-gradient-to-br from-slate-950 via-cyan-900 to-cyan-600 border border-cyan-900/50" },
];
      ...
      <div className="flex flex-col gap-6 max-w-7xl mx-auto">
        {proyectos.map((p) => (
          <div key={p.id} id={p.id} className={`${CARD_BASE} ${p.color}`}>
            ...
            <p className="text-white/90 font-sans text-sm lg:text-base 2xl:text-lg 4k:text-xl leading-relaxed">
              {p.descripcion}
            </p>
            <div className="flex justify-between items-center mt-auto">
              ...
              <a href={p.github} target="_blank" rel="noopener noreferrer">
                <img src="/git96.png" alt="GitHub" width="40" height="28" className="border border-white/20 rounded" />
              </a>
            </div>
          </div>
        ))}

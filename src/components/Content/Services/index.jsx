...
const Servicios = ({ refServicios }) => {
  return (
    <div 
      id="serv-title"
      ref={refServicios}
      class="fixed w-full flex flex-col items-center justify-center z-1 px-4 py-16  left-0 right-0 mx-auto
          top-10 bottom-0 max-h-screen 
         lg:bottom-180
        4k:left-0
    ...
    >
      ...
      <div 
        id="servicios-grid"
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:relative lg:left-0 gap-4 max-w-6xl mx-auto w-full lg:-top-5 lg:w-full "
      >
        <div 
          id="servicio-box"
        ...
        >
          <h3 class="text-lg font-semibold mb-2  2xl:text-2xl 4k:text-3xl
 ...
 2xl:text-2xl
      ...
      <div class="mt-12 text-center">
        <a
          ...
          relative bottom-8
          lg:relative lg:bottom-15 font-bold font-sans

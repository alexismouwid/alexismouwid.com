...
const Servicios = ({ refServicios }) => {
  return (
    <div 
      id="serv-title"
      ref={refServicios}
      class="fixed w-full flex flex-col items-center justify-center z-1 px-4 py-16 bg-[linear-gradient(to_right,_#0f2027,_#8e2de2)] relative bottom-240 lg:bottom-180"
    >
      <h1 
        id="servicios-titulo"
        class="text-1xl font-extrabold mb-12 text-center bg-gradient-to-r from-[#D4FF00] via-[#0084ff] to-[#00ffd4] bg-clip-text text-transparent mx-auto"
      >
      ...
      <div 
        id="servicios-grid"
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:relative lg:left-50 gap-2 max-w-6xl mx-auto w-full"
      >
        <div 
          id="servicio-box"
        ...
        >
          ...
          <p class="text-[0.8rem] lg:text-sm text-balance leading-relaxed ">
        ...
        >
          ...
          <p class="text-[0.8rem] text-sm leading-relaxed">
